...
<details>
  ...
  ```html
  <dy-button @click="handleButtonClick">Click Me</dy-button>
  ```
...
<details>
  ...
  <dy-table-column label="操作">
    <template slot-scope="props">
      <dy-button @click.native="showDetail(props.row)">查看详情</dy-button>
    </template>
  </dy-table-column>
  ```
  参数 `row` 即为对应行的数据。
...
<details>
  ...
  <dy-table-column label="Operations">
    <template slot-scope="props">
      <dy-button @click.native="showDetail(props.row)">Details</dy-button>
    </template>
  </dy-table-column>
  ```
...
<details>
  ...
  ```html
  <dy-button @click="handleButtonClick">Haga Clic Aquí</dy-button>
  ```
...
<details>
  ...
  ```html
  <dy-table-column label="Operaciones">
    <template slot-scope="props">
      <dy-button @click.native="verDetalles(props.row)">Detalles</dy-button>
    </template>
  </dy-table-column>
  ```
