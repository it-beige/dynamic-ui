...
import { range as rangeArr, getFirstDayOfMonth, getPrevMonthLastDays, getMonthDays, getI18nSettings, validateRangeInOneMonth } from 'dynamic-ui/src/utils/date-util';
        ...
        <tbody>
          {
            this.rows.map((row, index) => <tr
              class={{
                'dy-calendar-table__row': true,
                'dy-calendar-table__row--hide-border': index === 0 && this.hideHeader
              }}
              key={index}>
              {
