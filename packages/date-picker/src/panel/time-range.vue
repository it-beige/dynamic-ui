<template>
  <transition
    ...
    <div
      v-show="visible"
      class="dy-time-range-picker dy-picker-panel dy-popper"
      :class="popperClass">
      <div class="dy-time-range-picker__content">
        <div class="dy-time-range-picker__cell">
          <div class="dy-time-range-picker__header">{{ t('dy.datepicker.startTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="dy-time-range-picker__body dy-time-panel__content">
            <time-spinner
              ref="minSpinner"
        ...
        <div class="dy-time-range-picker__cell">
          <div class="dy-time-range-picker__header">{{ t('dy.datepicker.endTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="dy-time-range-picker__body dy-time-panel__content">
            <time-spinner
      ...
      <div class="dy-time-panel__footer">
        <button
          type="button"
          class="dy-time-panel__btn cancel"
          @click="handleCancel()">{{ t('dy.datepicker.cancel') }}</button>
        <button
          type="button"
          class="dy-time-panel__btn confirm"
          @click="handleConfirm()"
          :disabled="btnDisabled">{{ t('dy.datepicker.confirm') }}</button>
      </div>
    </div>
  </transition>
</template>
