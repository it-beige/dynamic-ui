<template>
  <transition name="dy-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="dy-time-panel dy-popper"
      :class="popperClass">
      <div class="dy-time-panel__content" :class="{ 'has-seconds': showSeconds }">
        <time-spinner
          ref="spinner"
          @change="handleChange"
      ...
      <div class="dy-time-panel__footer">
        ...
        <button
          type="button"
          class="dy-time-panel__btn"
          :class="{confirm: !disabled}"
          @click="handleConfirm()">{{ t('dy.datepicker.confirm') }}</button>
      </div>
    </div>
  </transition>
</template>
...
<script type="text/babel">
  import { limitTimeRange, isDate, clearMilliseconds, timeWithinRange } from 'dynamic-ui/src/utils/date-util';
