<template>
  <table @click="handleYearTableClick" class="dy-year-table">
    <tbody>
    <tr>
...
<script type="text/babel">
  ...
  import { isDate, range, nextDate, getDayCountOfYear } from 'dynamic-ui/src/utils/date-util';
  import { arrayFindIndex, coerceTruthyValueToArray } from 'dynamic-ui/src/utils/util';
