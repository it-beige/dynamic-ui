<template>
  <table @click="handleMonthTableClick" @mousemove="handleMouseMove" class="dy-month-table">
    <tbody>
    <tr v-for="(row, key) in rows" :key="key">
      <td :class="getCellStyle(cell)" v-for="(cell, key) in row" :key="key">
        <div>
          <a class="cell">{{ t('dy.datepicker.months.' + months[cell.text]) }}</a>
        </div>
      </td>
    </tr>
    </tbody>
...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'dynamic-ui/src/utils/date-util';
  import { hasClass } from 'dynamic-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'dynamic-ui/src/utils/util';
