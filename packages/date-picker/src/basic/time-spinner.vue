<template>
  <div class="dy-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <dy-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="dy-time-spinner__wrapper"
        wrap-style="max-height: inherit;"
        view-class="dy-time-spinner__list"
        noresize
        tag="ul"
        ref="hours">
        <li
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="dy-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease" class="dy-time-spinner__arrow dy-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="dy-time-spinner__arrow dy-icon-arrow-down"></i>
        <ul class="dy-time-spinner__list" ref="hours">
          <li
            class="dy-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="dy-time-spinner__arrow dy-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="dy-time-spinner__arrow dy-icon-arrow-down"></i>
        <ul class="dy-time-spinner__list" ref="minutes">
          <li
            class="dy-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="dy-time-spinner__arrow dy-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="dy-time-spinner__arrow dy-icon-arrow-down"></i>
        <ul class="dy-time-spinner__list" ref="seconds">
          <li
...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'dynamic-ui/src/utils/date-util';
  import DyScrollbar from 'dynamic-ui/packages/scrollbar';
  import RepeatClick from 'dynamic-ui/src/directives/repeat-click';
