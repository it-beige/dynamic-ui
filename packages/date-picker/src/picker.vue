<template>
  <dy-input
    class="dy-date-editor"
    :class="'dy-date-editor--' + type"
  ...
  <div
    class="dy-date-editor dy-range-editor dy-input__inner"
    :class="[
      'dy-date-editor--' + type,
      pickerSize ? `dy-range-editor--${ pickerSize }` : '',
    ...
    v-clickoutside="handleClose"
    v-else>
    <i :class="['dy-input__icon', 'dy-range__icon', triggerClass]"></i>
    <input
      autocomplete="off"
      ...
      @focus="handleFocus"
      class="dy-range-input">
    <slot name="range-separator">
      <span class="dy-range-separator">{{ rangeSeparator }}</span>
    </slot>
    <input
      autocomplete="off"
    ...
    <i
      ...
      v-if="haveTrigger"
      :class="[showClose ? '' + clearIcon : '']"
      class="dy-input__icon dy-range__close-icon">
    </i>
  </div>
</template>
...
import { formatDate, parseDate, isDateObject, getWeekNumber } from 'dynamic-ui/src/utils/date-util';
import Popper from 'dynamic-ui/src/utils/vue-popper';
import Emitter from 'dynamic-ui/src/mixins/emitter';
import Input from 'dynamic-ui/packages/input';
...
export default {
  ...
  computed: {
    ...
    triggerClass() {
      return this.prefixIcon || (this.type.indexOf('time') !== -1 ? 'dy-icon-time' : 'dy-icon-date');
    },
