import Vue from 'vue';
import { hasClass, addClass, removeClass } from 'dynamic-ui/src/utils/dom';
...
export default {
        ...
        <thead class={ [{ 'is-group': isGroup, 'has-gutter': this.hasGutter }] }>
          {
            this._l(columnRows, (columns, rowIndex) =>
              ...
              >
                ...
                {
                  this.hasGutter ? <th class="dy-table__cell gutter"></th> : ''
                }
              </tr>
            )
          }
  ...
  methods: {
    ...
    handleFilterClick(event, column) {
      ...
      cell = cell.querySelector('.dy-table__column-filter-trigger') || cell;
