<script>
  ...
  import DyRadio from 'dynamic-ui/packages/radio';
  import { isEqual } from 'dynamic-ui/src/utils/util';
  ...
  export default {
    ...
    methods: {
      ...
      renderCheckIcon(h) {
        return (
          <i class="dy-icon-check dy-cascader-node__prefix"></i>
        );
      },

      renderLoadingIcon(h) {
        return (
          <i class="dy-icon-loading dy-cascader-node__postfix"></i>
        );
      },

      renderExpandIcon(h) {
        return (
          <i class="dy-icon-arrow-right dy-cascader-node__postfix"></i>
        );
      },
      ...
      renderContent(h) {
        ...
        return (
          <span class="dy-cascader-node__label">{ vnode || node.label }</span>
        );
      }
    },
