  ...
  >
    ...
    >
      ...
      >
        ...
        >
          <dy-option :value="query" created v-if="showNewOption"></dy-option>
          <slot></slot>
        </dy-scrollbar>
        <template
          v-if="
        ...
        <template v-if="!allowCreate && !loading">
...
} from 'dynamic-ui/src/utils/resize-event';
    ...
    autoComplete: {
      ...
      validator(val) {
        process.env.NODE_ENV !== 'production' &&
          console.warn(
            "[Dynamic Warn][Select]'auto-complete' property will be deprecated in next major version. please use 'autocomplete' instead.",
          );
        return true;
      }
    },
