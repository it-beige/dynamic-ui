...
import { isFunction } from 'dynamic-ui/src/utils/types';
...
export default {
  ...
  render () {
    ...
    return (
      <div class="dy-descriptions">
        {
          (title || extra || $slots.title || $slots.extra)
            ? <div class="dy-descriptions__header">
              <div class="dy-descriptions__title">
                { $slots.title ? $slots.title : title}
              </div>
              <div class="dy-descriptions__extra">
        ...
        <div class="dy-descriptions__body">
          <table class={['dy-descriptions__table', {'is-bordered': border}, descriptionsSize ? `dy-descriptions--${descriptionsSize}` : '']}>
            {rows.map(row => (
