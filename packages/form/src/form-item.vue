<template>
  <div class="dy-form-item" :class="[{
    ...
    <label-wrap
      ...
      <label :for="labelFor" class="dy-form-item__label" :style="labelStyle" v-if="label || $slots.label">
        <slot name="label">{{label + form.labelSuffix}}</slot>
      </label>
    </label-wrap>
    <div class="dy-form-item__content" :style="contentStyle">
      <slot></slot>
...
<script>
  ...
  import { noop, getPropByPath } from 'dynamic-ui/src/utils/util';
  import LabelWrap from './label-wrap';
  export default {
    name: 'DyFormItem',

    componentName: 'DyFormItem',
    ...
    computed: {
      ...
      form() {
        ...
        while (parentName !== 'DyForm') {
          if (parentName === 'DyFormItem') {
            this.isNested = true;
          }
    ...
    methods: {
      ...
      resetField() {
        ...
        this.broadcast('DyTimeSelect', 'fieldReset', this.initialValue);
      },
      getRules() {
