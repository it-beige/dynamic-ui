    ...
    <span
      ...
      <i
        ...
        <i
          ...
          :style="decimalStyle"
          class="dy-rate__decimal">
        </i>
      </i>
    </span>
    <span v-if="showText || showScore" class="dy-rate__text" :style="{ color: textColor }">{{ text }}</span>
  </div>
</template>

<script>
  import { hasClass } from 'dynamic-ui/src/utils/dom';
  import { isObject } from 'dynamic-ui/src/utils/types';
  ...
  export default {
    ...
    props: {
      ...
      iconClasses: {
        type: [Array, Object],
        default() {
          return ['dy-icon-star-on', 'dy-icon-star-on', 'dy-icon-star-on'];
        }
      },
      voidIconClass: {
        type: String,
        default: 'dy-icon-star-off'
      },
      disabledVoidIconClass: {
        type: String,
        default: 'dy-icon-star-on'
      },
      disabled: {
        type: Boolean,
        default: false
    ...
    methods: {
      ...
      setCurrentValue(value, event) {
        ...
        if (this.allowHalf) {
          ...
          if (hasClass(target, 'dy-rate__item')) {
            target = target.querySelector('.dy-rate__icon');
          }
          if (hasClass(target, 'dy-rate__decimal')) {
