  ...
  <div class="headerWrapper">
    <div id="v3-banner" v-if="isHome">
      <template v-if="lang === 'zh-CN'">
        您正在浏览基于 Vue 2.x 的 Dynamuc UI 文档;
        <a href="https://element-plus.org/#/zh-CN">点击这里</a> 查看 Vue 3.x 的升级版本
      </template>
      <template v-else>
        You’re browsing the documentation of Dynamic UI for Vue 2.x version.
    ...
    <header class="header" ref="header">
      <div class="container">
        <h1><router-link :to="`/${ lang }`">
          ...
          <slot>
            <img
              src="../assets/images/dynamic-logo.svg"
              alt="element-logo"
              class="nav-logo">
            <img
              src="../assets/images/dynamic-logo-small.svg"
              alt="element-logo"
