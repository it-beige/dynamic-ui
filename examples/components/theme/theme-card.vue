        ...
        <div class="info-center">
          <div class="title">
            ...
            <span class="right more" v-else>
              <dy-dropdown @command="actionClick">
                <i class="dy-icon-more"></i>
                <dy-dropdown-menu slot="dropdown">
                  <dy-dropdown-item command="rename">{{getActionDisplayName('rename-theme')}}</dy-dropdown-item>
                  <dy-dropdown-item command="copy">{{getActionDisplayName('copy-theme')}}</dy-dropdown-item>
                  <dy-dropdown-item
                      command="delete"
                      style="color: #F56C6C;"
                    >
...
import dateUtil from 'dynamic-ui/src/utils/date';
