<template>
  <div :style="{ 
    ...
    <dy-dialog :visible.sync="copyDialogVisible" :modal-append-to-body="false">
      <dy-form :model="copyForm" ref="copyForm" :rules="copyFormRule">
        <dy-form-item label="主题名称" prop="name">
          <dy-input v-model="copyForm.name"></dy-input>
        </dy-form-item>
      </dy-form>
      <div slot="footer" class="dialog-footer">
        <dy-button @click="closeCopyForm">取消</dy-button>
        <dy-button type="primary" @click="copyToUser">确认</dy-button>
      </div>
    </dy-dialog>
  </div>
</template>
