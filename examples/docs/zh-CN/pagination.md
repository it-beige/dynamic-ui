...
<div class="block">
  ...
  <dy-pagination layout="prev, pager, next" :total="50"></dy-pagination>
</div>
<div class="block">
  <span class="demonstration">大于 7 页时的效果</span>
  <dy-pagination layout="prev, pager, next" :total="1000"></dy-pagination>
</div>
```
...
```html
<dy-pagination small layout="prev, pager, next" :total="50"></dy-pagination>
```
