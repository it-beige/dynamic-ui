...
<dy-dropdown>
  ...
  <dy-dropdown-menu slot="dropdown">
    ...
    <dy-dropdown-item disabled>双皮奶</dy-dropdown-item>
    <dy-dropdown-item divided>蚵仔煎</dy-dropdown-item>
  </dy-dropdown-menu>
</dy-dropdown>
...
<dy-row class="block-col-2">
  <dy-col :span="12">
    ...
    <dy-dropdown>
      ...
      <dy-dropdown-menu slot="dropdown">
        <dy-dropdown-item icon="dy-icon-plus">黄金糕</dy-dropdown-item>
        <dy-dropdown-item icon="dy-icon-circle-plus">狮子头</dy-dropdown-item>
        <dy-dropdown-item icon="dy-icon-circle-plus-outline">
          螺蛳粉
        </dy-dropdown-item>
        <dy-dropdown-item icon="dy-icon-check">双皮奶</dy-dropdown-item>
        <dy-dropdown-item icon="dy-icon-circle-check">蚵仔煎</dy-dropdown-item>
      </dy-dropdown-menu>
    </dy-dropdown>
  </dy-col>
  <dy-col :span="12">
...
<dy-dropdown @command="handleCommand">
  ...
  <dy-dropdown-menu slot="dropdown">
    ...
    <dy-dropdown-item command="d" disabled>双皮奶</dy-dropdown-item>
    <dy-dropdown-item command="e" divided>蚵仔煎</dy-dropdown-item>
  </dy-dropdown-menu>
</dy-dropdown>
...
| dropdown | 下拉列表，通常是 `<dy-dropdown-menu>` 组件                 |
