...
```shell
yarn add dynamic-ui -S
```

### CDN

目前可以通过 [unpkg.com/dynamic-ui](https://unpkg.com/dynamic-ui/) 获取到最新版本的资源，在页面上引入 js 和 css 文件即可开始使用。
...
:::tip
我们建议使用 CDN 引入 Dynamic 的用户在链接地址上锁定版本，以免将来 Dynamic 升级时受到非兼容性更新的影响。锁定版本的方法请查看 [unpkg.com](https://unpkg.com)。
:::

### Hello world

通过 CDN 的方式我们可以很容易地使用 Dynamic 写出一个 Hello world 页面。[在线演示](https://codepen.io/bofeng/pen/poaEmJY)
