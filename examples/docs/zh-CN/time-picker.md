...
| is-range          | 是否为时间范围选择，仅对`<dy-time-picker>`有效                       | boolean                               | —                                                        | false                |
| arrow-control     | 是否使用箭头进行时间选择，仅对`<dy-time-picker>`有效                 | boolean                               | —                                                        | false                |
...
| name              | 原生属性                                                             | string                                | —                                                        | —                    |
| prefix-icon       | 自定义头部图标的类名                                                 | string                                | —                                                        | dy-icon-time         |
