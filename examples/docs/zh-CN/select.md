...
```html
<template>
  <dy-select v-model="value" placeholder="请选择">
    <dy-option
...
```html
<template>
  <dy-select v-model="value" disabled placeholder="请选择">
    <dy-option
      v-for="item in options"
      :key="item.value"
      :label="item.label"
...
```html
<template>
  <dy-select v-model="value" clearable placeholder="请选择">
    <dy-option
      v-for="item in options"
      :key="item.value"
      :label="item.label"
...
```html
<template>
  <dy-select v-model="value1" multiple placeholder="请选择">
    <dy-option
      v-for="item in options"
      :key="item.value"
      :label="item.label"
...
```html
<template>
  <dy-select v-model="value" filterable placeholder="请选择">
    <dy-option
      v-for="item in options"
      :key="item.value"
      :label="item.label"
