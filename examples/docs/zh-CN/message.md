...
```html
<template>
  <dy-button :plain="true" @click="open">打开消息提示</dy-button>
...
```html
<template>
  <dy-button :plain="true" @click="open2">成功</dy-button>
  <dy-button :plain="true" @click="open3">警告</dy-button>
  <dy-button :plain="true" @click="open1">消息</dy-button>
  <dy-button :plain="true" @click="open4">错误</dy-button>
</template>
...
```html
<template>
  <dy-button :plain="true" @click="openCenter">文字居中</dy-button>
</template>
...
```html
<template>
  <dy-button :plain="true" @click="openHTML">使用 HTML 片段</dy-button>
</template>
