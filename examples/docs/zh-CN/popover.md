...
<template>
  ...
  <dy-popover
    ...
    content="这是一段内容,这是一段内容,这是一段内容,这是一段内容。"
  ></dy-popover>
  <dy-button v-popover:popover>focus 激活</dy-button>
  ...
  <dy-popover
    ...
    v-model="visible"
  >
    <dy-button slot="reference" @click="visible = !visible">手动激活</dy-button>
  </dy-popover>
</template>
...
<dy-popover placement="right" width="400" trigger="click">
  <dy-table :data="gridData">
    <dy-table-column width="150" property="date" label="日期"></dy-table-column>
    <dy-table-column width="100" property="name" label="姓名"></dy-table-column>
    <dy-table-column
      width="300"
      property="address"
      label="地址"
...
<dy-popover placement="top" width="160" v-model="visible">
  ...
  <div style="text-align: right; margin: 0">
    <dy-button size="mini" type="text" @click="visible = false">取消</dy-button>
