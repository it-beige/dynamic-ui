...
- 通过全局配置的`request`之后可以实现数据的请求和处理,只关注配置
...
>
  ...
  <dy-edit-table-column-generate label="头像" width="80">
    <dy-avatar
      src="https://cdn.jsdelivr.net/gh/it-beige/dynamic-assets/images/beige.jpg"
    ></dy-avatar>
  </dy-edit-table-column-generate>

  <dy-edit-table-column-generate fixed="right" label="操作" width="60">
...
<script>
  ...
  export default {
    ...
    methods: {
      getTableRef() {
        console.log(this.$refs.tableGenerateRef.$refs.VxeTable)
        // or
