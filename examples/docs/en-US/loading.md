...
```html
<template>
  <dy-table v-loading="loading" :data="tableData" style="width: 100%">
...
<template>
  ...
  <dy-button type="primary" @click="openFullScreen2">
    As a service
  </dy-button>
</template>
...
```javascript
import { Loading } from 'dynamic-ui';
```
