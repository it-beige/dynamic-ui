...
<template>
  <dy-table :data="tableData" style="width: 100%">
    <dy-table-column prop="date" label="Date" width="180"></dy-table-column>
    <dy-table-column prop="name" label="Name" width="180"></dy-table-column>
...
```html
<template>
  <dy-table :data="tableData" height="250" style="width: 100%">
    <dy-table-column prop="date" label="Date" width="180"></dy-table-column>
    <dy-table-column prop="name" label="Name" width="180"></dy-table-column>
    <dy-table-column prop="address" label="Address"></dy-table-column>
  </dy-table>
...
<template>
  <dy-table :data="tableData" style="width: 100%">
    ...
    <dy-table-column prop="state" label="State" width="120"></dy-table-column>
    <dy-table-column prop="city" label="City" width="120"></dy-table-column>
    <dy-table-column
      prop="address"
      label="Address"
      width="300"
    ></dy-table-column>
    <dy-table-column prop="zip" label="Zip" width="120"></dy-table-column>
    <dy-table-column fixed="right" label="Operations" width="120">
      <template slot-scope="scope">
        <dy-button @click="handleClick" type="text" size="small">
          Detail
        </dy-button>
        <dy-button type="text" size="small">Edit</dy-button>
      </template>
    </dy-table-column>
  </dy-table>
</template>
...
<template>
  <dy-table :data="tableData" style="width: 100%">
    <dy-table-column prop="date" label="Date" width="150"></dy-table-column>
    <dy-table-column label="Delivery Info">
      <dy-table-column prop="name" label="Name" width="120"></dy-table-column>
      <dy-table-column label="Address Info">
        <dy-table-column
          prop="state"
          label="State"
          width="120"
...
<template>
  ...
  >
    ...
    <dy-table-column property="date" label="Date" width="120"></dy-table-column>
    <dy-table-column property="name" label="Name" width="120"></dy-table-column>
    <dy-table-column property="address" label="Address"></dy-table-column>
  </dy-table>
  <div style="margin-top: 20px">
    <dy-button @click="setCurrent(tableData[1])">Select second row</dy-button>
    <dy-button @click="setCurrent()">Clear selection</dy-button>
  </div>
</template>
...
<template>
  ...
  >
    ...
    <dy-table-column label="Date" width="120">
      <template slot-scope="scope">
        {{ scope.row.date }}
      </template>
    </dy-table-column>
  ...
  <div style="margin-top: 20px">
    ...
    <dy-button @click="toggleSelection()">Clear selection</dy-button>
  </div>
</template>
...
```html
<template>
  <dy-button @click="resetDateFilter">reset date filter</dy-button>
  <dy-button @click="clearFilter">reset all filters</dy-button>
...
<template>
  <dy-table :data="tableData" style="width: 100%">
    <dy-table-column label="Date" width="180">
      <template slot-scope="scope">
        <i class="dy-icon-time"></i>
        <span style="margin-left: 10px">{{ scope.row.date }}</span>
      </template>
    </dy-table-column>
    <dy-table-column label="Name" width="180">
      <template slot-scope="scope">
    ...
    <dy-table-column label="Operations">
      <template slot-scope="scope">
  ...
  >
    ...
    <dy-table-column align="right">
      <template slot="header" slot-scope="scope">
        <dy-input v-model="search" size="mini" placeholder="Type to search" />
      </template>
      <template slot-scope="scope">
        <dy-button size="mini" @click="handleEdit(scope.$index, scope.row)">
          Edit
...
<template>
  <dy-table :data="tableData" border show-summary style="width: 100%">
    ...
    <dy-table-column prop="name" label="Name"></dy-table-column>
    <dy-table-column prop="amount1" sortable label="Amount 1"></dy-table-column>
    <dy-table-column prop="amount2" sortable label="Amount 2"></dy-table-column>
    <dy-table-column prop="amount3" sortable label="Amount 3"></dy-table-column>
  </dy-table>
  ...
  >
    <dy-table-column prop="id" label="ID" width="180"></dy-table-column>
    <dy-table-column prop="name" label="Name"></dy-table-column>
    <dy-table-column prop="amount1" label="Cost 1 ($)"></dy-table-column>
    <dy-table-column prop="amount2" label="Cost 2 ($)"></dy-table-column>
    <dy-table-column prop="amount3" label="Cost 3 ($)"></dy-table-column>
  </dy-table>
</template>
...
<template>
  <div>
    ...
    >
      <dy-table-column prop="id" label="ID" width="180"></dy-table-column>
      <dy-table-column prop="name" label="Name"></dy-table-column>
      <dy-table-column prop="amount1" label="Amount 1"></dy-table-column>
      <dy-table-column prop="amount2" label="Amount 2"></dy-table-column>
      <dy-table-column prop="amount3" label="Amount 3"></dy-table-column>
    </dy-table>
  </div>
</template>
