...
```html
<dy-tag>Tag 1</dy-tag>
<dy-tag type="success">Tag 2</dy-tag>
<dy-tag type="info">Tag 3</dy-tag>
<dy-tag type="warning">Tag 4</dy-tag>
<dy-tag type="danger">Tag 5</dy-tag>
```
...
```html
<dy-tag>Default</dy-tag>
<dy-tag size="medium">Medium</dy-tag>
<dy-tag size="small">Small</dy-tag>
<dy-tag size="mini">Mini</dy-tag>
```
