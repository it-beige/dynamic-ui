...
```html
<template>
  <dy-button plain @click="open1">
    Closes automatically
  </dy-button>
  <dy-button plain @click="open2">
...
<template>
  ...
  <dy-button plain @click="open3">
    Info
  </dy-button>
  <dy-button plain @click="open4">
    Error
  </dy-button>
</template>
...
```javascript
import { Notification } from 'dynamic-ui';
```
