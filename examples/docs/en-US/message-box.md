...
```html
<template>
  <dy-button type="text" @click="open">Click to open the Message Box</dy-button>
</template>
...
```html
<template>
  <dy-button type="text" @click="open">Click to open Message Box</dy-button>
</template>
...
```javascript
import { MessageBox } from 'dynamic-ui';
```
