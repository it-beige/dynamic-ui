...
<div class="buttons">
  <dy-button @click="getCheckedNodes">get by node</dy-button>
  <dy-button @click="getCheckedKeys">get by key</dy-button>
  <dy-button @click="setCheckedNodes">set by node</dy-button>
  <dy-button @click="setCheckedKeys">set by key</dy-button>
  <dy-button @click="resetChecked">reset</dy-button>
</div>
...
```html
<dy-input placeholder="Filter keyword" v-model="filterText"></dy-input>
