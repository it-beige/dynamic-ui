...
describe('Slider', () => {
  ...
  it('should not exceed min and max', done => {
    vm = createVue({
      template: `
        <div>
          <dy-slider v-model="value" :min="50">
          </dy-slider>
        </div>
      `,
  ...
  it('hide tooltip', () => {
    vm = createVue({
      template: `
        <div>
          <dy-slider v-model="value" :show-tooltip="false">
          </dy-slider>
        </div>
      `,
  ...
  it('format tooltip', async () => {
    vm = createVue({
      template: `
        <div>
          <dy-slider ref="slider" v-model="value" :format-tooltip="formatTooltip">
          </dy-slider>
        </div>
      `,
  ...
  it('drag', done => {
    vm = createVue({
      template: `
        <div>
          <dy-slider v-model="value" :vertical="vertical"></dy-slider>
        </div>
      `,
  ...
  it('accessibility', done => {
    vm = createVue({
      template: `
        <div>
          <dy-slider v-model="value"></dy-slider>
        </div>
      `,
    ...
    vm = createVue({
      template: `
        <div style="width: 200px;">
          <dy-slider v-model="value" :min="0" :max="1" :step="0.1"></dy-slider>
        </div>
      `,
  ...
  it('change event', done => {
    vm = createVue({
      template: `
        <div>
          <dy-slider v-model="value" @change="onChange">
          </dy-slider>
        </div>
      `,
  ...
  it('disabled', done => {
    vm = createVue({
      template: `
        <div>
          <dy-slider v-model="value" disabled></dy-slider>
        </div>
      `,
  ...
  it('show input', done => {
    ...
    setTimeout(() => {
      triggerEvent(vm.$el.querySelector('.dy-input-number'), 'keyup');
      const inputNumber = vm.$el.querySelector('.dy-input-number').__vue__;
  ...
  it('show stops', () => {
    ...
    const stops = vm.$el.querySelectorAll('.dy-slider__stop');
  ...
  it('vertical mode', done => {
    vm = createVue({
      template: `
        <div>
          <dy-slider vertical v-model="value" height="200px"></dy-slider>
        </div>
      `,
  ...
  describe('range', () => {
    it('basic ranged slider', () => {
      vm = createVue({
        template: `
        <div>
          <dy-slider v-model="value" range></dy-slider>
        </div>
      `,
    ...
    it('should not exceed min and max', done => {
      vm = createVue({
        template: `
        <div>
          <dy-slider v-model="value" range :min="50">
          </dy-slider>
        </div>
      `,
    ...
    it('click', done => {
      vm = createVue({
        template: `
        <div style="width: 200px;">
          <dy-slider range v-model="value"></dy-slider>
        </div>
      `,
    ...
    it('responsive to dynamic min and max', done => {
      vm = createVue({
        template: `
        <div>
          <dy-slider v-model="value" range :min="min" :max="max">
          </dy-slider>
        </div>
      `,
    ...
    it('marks', async () => {
      ...
      waitImmediate();
      const stops = vm.$el.querySelectorAll('.dy-slider__marks-stop.dy-slider__stop');
      const marks = vm.$el.querySelectorAll('.dy-slider__marks .dy-slider__marks-text');
