...
describe('InputNumber', () => {
  ...
  it('decrease', done => {
    ...
    let input = vm.$el.querySelector('input');
    let btnDecrease = vm.$el.querySelector('.dy-input-number__decrease');
  ...
  it('increase', done => {
    ...
    let input = vm.$el.querySelector('input');
    let btnIncrease = vm.$el.querySelector('.dy-input-number__increase');
  ...
  describe('precision', () => {
    ...
    it('precision greater than the precision of step', done => {
      ...
      const btnIncrease = vm.$el.querySelector('.dy-input-number__increase');
  ...
  it('controls', () => {
    ...
    expect(vm.$el.querySelector('.dy-input-number__decrease')).to.not.exist;
    expect(vm.$el.querySelector('.dy-input-number__increase')).to.not.exist;
  });
  ...
  it('focus', done => {
    vm = createVue({
      template: `
        <dy-input-number ref="input"></dy-input-number>
      `
    }, true);
