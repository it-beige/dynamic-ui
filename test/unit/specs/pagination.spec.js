...
describe('Pagination', () => {
  ...
  it('create', () => {
    ...
    // pager
    expect(elm.querySelector('ul.dy-pager')).to.exist;
    // next
    expect(elm.querySelector('button.btn-next')).to.exist;
    // jumper
    expect(elm.querySelector('.dy-pagination__jump')).to.exist;
    // ->
    expect(elm.querySelector('.dy-pagination__rightwrapper')).to.exist;
  });
  ...
  it('set layout', () => {
    ...
    expect(elm.querySelector('button.btn-next')).to.exist;
    // not found jumper
    expect(elm.querySelector('.dy-pagination__jump')).to.not.exist;
    // not found ->
    expect(elm.querySelector('.dy-pagination__rightwrapper')).to.not.exist;
    // not found total
    expect(elm.querySelector('.dy-pagination__total')).to.not.exist;
  });
  ...
  it('layout: all in right, need clear float', () => {
    ...
    const elm = vm.$el;
    let right_div = elm.querySelector('.dy-pagination__rightwrapper');
  ...
  it('pageSizes', () => {
    ...
    expect(vm.$el.querySelector('.dy-select-dropdown__item.selected')).to.property('textContent').include('35');
    expect([].slice.call(vm.$el.querySelectorAll('.dy-select-dropdown__item'))
  ...
  it('pageSizes:not found pageSize', () => {
    ...
    expect(vm.$el.querySelector('.dy-select-dropdown__item.selected')).to.property('textContent').include('10');
  });
  ...
  it('event:size-change', done => {
    ...
    setTimeout(_ => {
      vm.$el.querySelectorAll('li.dy-select-dropdown__item')[1].click();
      setTimeout(_ => {
  ...
  it('pageSize > total', () => {
    ...
    const input = vm.$el.querySelector('.dy-pagination__jump input');
  ...
  describe('click pager', () => {
    it('click ul', () => {
      ...
      vm.$el.querySelector('.dy-pager').click();
    ...
    it('click li', () => {
      ...
      vm.$el.querySelectorAll('.dy-pager li.number')[1].click();
    ...
    it('click next icon-more', () => {
      ...
      vm.$el.querySelector('.dy-pager .more').click();
