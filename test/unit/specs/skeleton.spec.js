...
describe('Skeleton.vue', () => {
  ...
  it('render test', () => {
    ...
    const el = vm.$el;
    expect(el.querySelectorAll('.dy-skeleton__p').length).to.equal(4);
  ...
  it('should render x times', async () => {
    ...
    const wrapper = vm.$el;
    expect(wrapper.querySelectorAll('.dy-skeleton__p').length).to.equal(4);

    vm.count = 2;

    await waitImmediate();
    expect(wrapper.querySelectorAll('.dy-skeleton__p').length).to.equal(8);
  });
  ...
  it('should render x rows', () => {
    ...
    expect(vm.$el.querySelectorAll('.dy-skeleton__p').length).to.equal(5);
  });
