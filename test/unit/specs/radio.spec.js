...
describe('Radio', () => {
  ...
  describe('Radio group', () => {
      ...
      vm = createVue({
        template: `
          <dy-radio-group v-model="radio">
            <dy-radio :label="3" ref="radio1">备选项</dy-radio>
            <dy-radio :label="6" ref="radio2">备选项</dy-radio>
    ...
    it('disabled', done => {
      vm = createVue({
        template: `
          <dy-radio-group v-model="radio" disabled>
            <dy-radio :label="3" ref="radio1">备选项</dy-radio>
            <dy-radio :label="6" ref="radio2">备选项</dy-radio>
            <dy-radio :label="9">备选项</dy-radio>
          </dy-radio-group>
    ...
    it('change event', done => {
      vm = createVue({
        template: `
          <dy-radio-group v-model="radio" @change="onChange">
    ...
    it('disabled when children is radio button', done => {
      vm = createVue({
        template: `
          <dy-radio-group v-model="radio" disabled>
            <dy-radio-button :label="3" ref="radio1">备选项</dy-radio-button>
            <dy-radio-button :label="6" ref="radio2">备选项</dy-radio-button>
    ...
    it('keyboard event', done => {
      vm = createVue({
        template: `
          <dy-radio-group v-model="radio">
            <dy-radio-button ref="radio1" :label="3">备选项</dy-radio-button>
            <dy-radio-button ref="radio2" :label="6">备选项</dy-radio-button>
    ...
    describe('Radio Button', () => {
      ...
      it('custom color', done => {
        vm = createVue({
          template: `
            <dy-radio-group v-model="radio" fill="#000" text-color="#ff0">
              <dy-radio-button :label="3" ref="radio1">备选项</dy-radio-button>
              <dy-radio-button :label="6" ref="radio2">备选项</dy-radio-button>
              <dy-radio-button :label="9">备选项</dy-radio-button>
            </dy-radio-group>
      ...
      it('change event', done => {
        vm = createVue({
          template: `
            <dy-radio-group v-model="radio" @change="onChange">
              <dy-radio-button :label="3">备选项</dy-radio-button>
              <dy-radio-button :label="6" ref="radio2">备选项</dy-radio-button>
              <dy-radio-button :label="9">备选项</dy-radio-button>
            </dy-radio-group>
          `,
      ...
      it('size', done => {
        vm = createVue({
          template: `
            <dy-radio-group v-model="radio" size="large">
              <dy-radio-button :label="3" ref="radio1">备选项</dy-radio-button>
              <dy-radio-button :label="6" ref="radio2">备选项</dy-radio-button>
              <dy-radio-button :label="9">备选项</dy-radio-button>
            </dy-radio-group>
        ...
        setTimeout(_ => {
          expect(vm.$el.querySelectorAll('.dy-radio-button--large').length).to.be.equal(3);
          done();
        }, 10);
      });
    });
