...
describe('Loading', () => {
  ...
  describe('as a directive', () => {
    it('create', done => {
      ...
      Vue.nextTick(() => {
        const mask = vm.$el.querySelector('.dy-loading-mask');
    ...
    it('unbind', done => {
      ...
      Vue.nextTick(() => {
        ...
        Vue.nextTick(() => {
          ...
          vm2.show = false;
          Vue.nextTick(() => {
            expect(document.querySelector('.dy-loading-mask')).to.not.exist;
            done();
          });
        });
      });
    ...
    it('body', done => {
      ...
      Vue.nextTick(() => {
        const mask = document.querySelector('.dy-loading-mask');
    ...
    it('lock', done => {
      ...
      Vue.nextTick(() => {
        ...
        vm.loading = false;
        document.body.removeChild(document.querySelector('.dy-loading-mask'));
        document.body.removeChild(vm.$el);
        done();
      });
    });
    ...
    it('text', done => {
      ...
      Vue.nextTick(() => {
        const mask = document.querySelector('.dy-loading-mask');
        const text = mask.querySelector('.dy-loading-text');
  ...
  describe('as a service', () => {
    it('create', () => {
      ...
      expect(document.querySelector('.dy-loading-mask')).to.exist;
    });
    ...
    it('target', done => {
      ...
      let mask = document.querySelector('.dy-loading-mask');
    ...
    it('fullscreen singleton', done => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          let masks = document.querySelectorAll('.dy-loading-mask');
          expect(masks.length).to.equal(1);
          loadingInstance2.close();
          setTimeout(() => {
            masks = document.querySelectorAll('.dy-loading-mask');
    ...
    it('text', () => {
      ...
      const text = document.querySelector('.dy-loading-text');
      expect(text).to.exist;
    ...
    it('customClass', () => {
      ...
      const customClass = document.querySelector('.dy-loading-custom-class');
